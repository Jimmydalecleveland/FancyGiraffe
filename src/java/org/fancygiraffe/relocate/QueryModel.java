...
public class QueryModel {
	...
	/**
	 * Returns all assets by asset tag
	 * @param id is the asset tag to search for
	 * @return CachedRowSet with matching assets
	 */
        ...
        try {
            ...
            if (rs != null) {
                ...
                if (rs.getString(1) != null) {
                    ...
                    sql2 = "SELECT a.tag, a.asset_name, a.asset_type, "
                            + "a.model, a.asset_condition, l.location_name "
                            + "FROM assets as a "
            ...
            new ErrorLog().LogError(ex.getMessage(), "GroupModel", "rowset");
        }
        finally {
            try {
                rs.close();
               ...
               new ErrorLog().LogError(ex.getMessage(), "GroupModel", "close connection");
            }
        }
